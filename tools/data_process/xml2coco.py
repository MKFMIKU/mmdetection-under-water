...
def main():
    xml_path = '/data2/UnderWater/train/box'
    img_path = '/data2/UnderWater/train/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/data2/UnderWater/train/annotations/train.json')
    print('Done!')
