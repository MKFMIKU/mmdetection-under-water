...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(4096, 540), (4096, 1080)], multiscale_mode='range', keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/data2/UnderWater/train/annotations/train.json',
...
log_level = 'INFO'
work_dir = './work_dirs/cas_x101_32x4d_fpn_htc_1x'
load_from = '/data2/UnderWater/pretrained/htc_x101_32x4d_fpn_20e_20190408-9eae4d0b.pth'
resume_from = None
workflow = [('train', 1)]
